# context-aware-transcription Specification

## Purpose
Improve transcription word accuracy by inferring a short context hint from the start of a recording, letting a human review/edit it, and steering the full transcription with the approved hint — without ever making the transcript worse than the unsteered baseline.
